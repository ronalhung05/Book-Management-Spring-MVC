...
@NamedQueries({
        ...
        @NamedQuery(name = "BookOrder.sumTotal", query = "SELECT SUM(bo.total) FROM BookOrder bo"),
        @NamedQuery(name = "BookOrder.sumTax", query = "SELECT SUM(bo.tax) FROM BookOrder bo"),
        @NamedQuery(name = "BookOrder.sumShippingFee", query = "SELECT SUM(bo.shippingFee) FROM BookOrder bo")
})

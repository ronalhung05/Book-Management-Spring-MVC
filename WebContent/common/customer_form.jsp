    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="password" id = "confirmPassword" name="confirmPassword" class="form-control" value="${customer.password}" required
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" id = "address2" name="address2" class="form-control" value="${customer.addressLine2}"
                       maxlength="128"/>
            </div>
        </div>
        <div class="col-md-6">
